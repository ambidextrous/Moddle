function initMap() {
	...
	google.maps.event.addListener(map, "click", function (e) {
		...
		if (confirm('Are you sure you want to set this position as your new location?')) {
			...
			sendToRegistrationForm(userChosenLat, userChosenLong);
...
function sendToRegistrationForm(userChosenLat,userChosenLong) {
	
	document.getElementById('userLat').value = userChosenLat;
	document.getElementById('userLong').value = userChosenLong;
	/**
